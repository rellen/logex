...
vocabulary. 722 lines of hand-written source — `lib/` + `src/*.xrl` +
...
contemporaneous run; the suite is now 27 tests.
...
14 of the suite's 24 tests as it landed; the file has since grown to 18 of 27.
...
- **B3 · CI.** Four lines: `mix compile --warnings-as-errors`,
  ...
  All four pass today, still true after M1-1 — now `27 tests, 0 failures`, and the
